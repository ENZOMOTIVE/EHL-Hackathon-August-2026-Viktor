...
| `export/` | Challenge data lives here (`*.jsonl`, plus the downloaded LICENSE) |
| `results/routes.jsonl` | Baseline routing output |
| `results/tables/frontier.csv` | Cost-quality sweep from `plot_frontier.py` |
| `results/figures/frontier.png` | Frontier plot when `matplotlib` is installed |
