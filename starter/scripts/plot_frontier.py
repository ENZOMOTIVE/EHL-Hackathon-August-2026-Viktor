...
Writes results/tables/frontier.csv (+ results/figures/frontier.png if matplotlib is installed).
"""
import json, sys, csv
...
def main():
    ...
    try:
        ...
        png = figures / "frontier.png"; plt.savefig(png, dpi=150)
        print(f"wrote {png}")
    except ImportError:
